...
contract EventTickets {
    ...
    */
    constructor(string memory description, string memory URL, uint _tickets) public {
        owner = msg.sender;
    ...
    */
    function buyTickets(uint _tickets) payable public{
        ...
        require(availableTickets >= _tickets,"Not enough Tickets available");
    ...
    */
    function getRefund() public {
        ...
        require(ticketsBought > 0, "No tickets bought from this address");
        myEvent.sales -= ticketsBought;
        myEvent.buyers[msg.sender] = 0;
        uint refundAmount = TICKET_PRICE * ticketsBought;
